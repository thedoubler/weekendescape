...
export default function PlaceLinks({
  ...
  const base =
    ...
    "flex h-11 w-11 items-center justify-center rounded-full text-muted-foreground transition hover:bg-black/[0.06] @2xl/card:h-9 @2xl/card:w-9 dark:hover:bg-white/10";
  return (
